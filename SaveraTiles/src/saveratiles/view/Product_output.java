 ...
 * @author User
 */
public class Product_output extends javax.swing.JFrame {

    DBConnection db = new DBConnection();
    PreparedStatement pst;
    String [] colums = {"Product Code","Product Name","Size","Total Quantity","Rate Psft","Origin","Date","Time"};
  ...
  model.setColumnIdentifiers(colums);
   tblProduct.setModel(model);
        ...
        try {
            ...
            model.addColumn(new Object[]{Pcode,Pname,Ssize,Quantity,Rate,Origin,Ddate,Ttime});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Product_output.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Product_output().setVisible(true);
            }
        });
    }
